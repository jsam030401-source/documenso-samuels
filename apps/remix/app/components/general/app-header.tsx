  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-screen-xl items-center justify-between gap-x-4 px-4 md:justify-normal md:px-8">
        ...
        >
          <SunIcon className="hidden h-5 w-5 text-muted-foreground transition-colors hover:text-foreground dark:block" />
          <MoonIcon className="h-5 w-5 text-muted-foreground transition-colors hover:text-foreground dark:hidden" />
        </Button>
